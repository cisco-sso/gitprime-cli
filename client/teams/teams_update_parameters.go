...
// WithData adds the data to the teams update params
func (o *TeamsUpdateParams) WithData(data TeamsUpdateBody) *TeamsUpdateParams {
	o.SetData(data)
	return o
}

// SetData adds the data to the teams update params
func (o *TeamsUpdateParams) SetData(data TeamsUpdateBody) {
	o.Data = data
}

// WithID adds the id to the teams update params
func (o *TeamsUpdateParams) WithID(id int64) *TeamsUpdateParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the teams update params
func (o *TeamsUpdateParams) SetID(id int64) {
	o.ID = id
}
