...
TeamMembershipDeleteNoContent team membership delete no content
*/
...
func (o *TeamMembershipDeleteNoContent) Error() string {
	return fmt.Sprintf("[DELETE /v3/customer/core/team_membership/{id}/][%d] teamMembershipDeleteNoContent  %+v", 204, o.Payload)
}

func (o *TeamMembershipDeleteNoContent) GetPayload() interface{} {
	return o.Payload
}
