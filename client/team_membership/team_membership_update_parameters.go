...
// WithData adds the data to the team membership update params
func (o *TeamMembershipUpdateParams) WithData(data TeamMembershipUpdateBody) *TeamMembershipUpdateParams {
	o.SetData(data)
	return o
}

// SetData adds the data to the team membership update params
func (o *TeamMembershipUpdateParams) SetData(data TeamMembershipUpdateBody) {
	o.Data = data
}
