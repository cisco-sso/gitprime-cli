...
// WithData adds the data to the team membership create params
func (o *TeamMembershipCreateParams) WithData(data TeamMembershipCreateBody) *TeamMembershipCreateParams {
	o.SetData(data)
	return o
}

// SetData adds the data to the team membership create params
func (o *TeamMembershipCreateParams) SetData(data TeamMembershipCreateBody) {
	o.Data = data
}
